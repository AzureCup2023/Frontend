...
import { BaseControlOptions } from 'src/components/Maps/Legend/BaseControl';
import { DynamicLayerGroup, LayerGroup, LayerState, LegendType } from 'src/components/Maps/Legend';
