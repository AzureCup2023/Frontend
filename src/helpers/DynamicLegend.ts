...
import { OgcMapLayer } from 'src/internal/TypingsOverrides';
import { CategoryLegendItem, CategoryLegendType, ColorStop, GradientLegendType, ImageLegendType, LegendControl, LegendType } from 'src/components/Maps/Legend';
